...
type OperatorTask struct {
	...
	Fn func(ctx OperatorContext) error
}
...
func RunConcurrently(ctx OperatorContext, tasks []OperatorTask) []error {
...
func (g *runGroup) trigger(ctx OperatorContext, task OperatorTask) {
	g.wg.Add(1)
